...
public class Usertable {
    ...
    public Usertable(String firstname, String lastname, String email, Date dob, double height, double weight, char gender, String address, int postcode, int levelofactivity, int stepspermile) {
